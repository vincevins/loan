  ...
  try {
    ...
    if (result.reset_required) {
      window.location.href =
        "http://localhost/casestudy-loan/loan/public/pages/set_password.php";
    } else if (result.status === "error") {
      showToast("error", result.message);
    } else if (result.role === "user") {
      window.location.href =
        "http://localhost/casestudy-loan/loan/public/pages/user/loan.php";
    } else if (result.role === "admin") {
      window.location.href =
        "http://localhost/casestudy-loan/loan/public/pages/admin/index.php";
    } else {
      window.location.href =
...
signupForm.addEventListener("submit", async function (e) {
  ...
  try {
    ...
    console.error(error);
    showToast("error", "Network or server error: " + error.message);
  }
});
