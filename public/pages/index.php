...
<body>
    ...
    <section class="how-it-works" id="how-it-works">
        <div class="section-header">
            ...
            <p class="section-subtitle">Get your loan in three simple steps</p>
        </div>
        <div class="steps-grid">
            <div class="step-card">
                <div class="step-number">1</div>
                <h3>Apply Online</h3>
                <p>Complete our simple application form with your employment details and required documents.</p>
            </div>
            <div class="step-card">
                <div class="step-number">2</div>
                <h3>Get Approved</h3>
                <p>Your HR will verify the information on your form. Then, our loan officers will review your application. You'll receive a decision soon after submission.</p>
            </div>
            <div class="step-card">
                <div class="step-number">3</div>
                <h3>Receive Funds</h3>
                <p>Once approved, your loan is disbursed directly to your account. Payment can be made via PayPal or payroll deduction.</p>
            </div>
        </div>
    </section>
    <setion class="about" id="about">
        <div class="about-content">
            <div class="about-text">
                <h2>About <span class="highlight">Our System</span></h2>
                <p>This system, which is an integrated employee loan management platform created to make easier the borrowing procedure for employees, this system is connected to two groups the payroll system and the HR (human resources) system.</p>

                <div class="mission-statement">
                    <h3><i class="fas fa-bullseye"></i> Our goal</h3>
                    <p>The main goal of the system is to facilitate employee access to financial assistance while ensuring data accuracy through manual verification by HR and loan officers, maintaining secure processing, and allowing flexible repayment methods such as payroll deduction or PayPal.</p>
                </div>
            </div>
            ...
            <div class="integration-cards">
                <div class="integration-card">
                    ...
                    <p>Manages the complete loan lifecycle - from application submission and document verification to approval. Our system calculates interest, generates repayment schedules, and tracks loan balances in real-time.</p>
                    <span class="integration-badge">Core Module</span>
                </div>
                ...
                <div class="integration-card">
                    ...
                    <p>Connects with the Human Resources system to verify employee information, employment status, and eligibility. HR officers can monitor loan applications and approve requests based on company policies and employee records.</p>
                    <span class="integration-badge">Partner System</span>
                </div>
                ...
                <div class="integration-card">
                    ...
                    <p>Allows for the direct deduction of monthly loan repayments from employee salaries by interacting with the payroll system. This ensures timely payments, and maintains accurate financial records.</p>
                    <span class="integration-badge">Partner System</span>
                </div>
            </div>
        </div>
        ...
        <section class="features" id="features">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <h3>One Connection. Smarter Pay.</h3>
                    <p>Link directly to your employer's payroll to automate payments. No manual steps required</p>
                </div>
                <div class="feature-card">
        ...
        <section id="faq">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>You can repay through PayPal and Payroll Deduction.</p>
                </div>
            </div>
        </section>
        <footer>
